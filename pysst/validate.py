...
# Optional imports (TEMP, validating needs to be replaced)
try:
...
class PointdataSchema(pa.SchemaModel):
    """
    Check dataframe for correct datatypes and coerce if required before creating
    PointdataCollection instance. The columns in this schema are required for
