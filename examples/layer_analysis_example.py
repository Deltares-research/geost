...
cores_with_gy = all_dino_cores.select_by_values("lith", ["GY", "DET", "DY"], how="or")
...
cores_with_gy.get_cumulative_layer_thickness(
    "lith", ["GY", "DET", "DY"], include_in_header=True
)
...
cores_with_gy.get_layer_top("lith", ["GY", "DET", "DY"], include_in_header=True)
