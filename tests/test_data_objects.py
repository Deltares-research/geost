...
class TestLayeredData:
    ...
    def test_select_by_values(self, borehole_data):
        ...
        selected = borehole_data.gstda.select_by_values("lith", ["V", "K"], how="and")
    ...
    def test_slice_by_values(self, borehole_data):
        ...
        sliced = borehole_data.gstda.slice_by_values("lith", "Z", invert=True)
    ...
    def test_get_cumulative_thickness(self, borehole_data):
        result = borehole_data.gstda.get_cumulative_thickness("lith", "V")
        ...
        result = borehole_data.gstda.get_cumulative_thickness("lith", ["Z", "K"])
    ...
    def test_get_layer_top(self, borehole_data):
        ...
        result = borehole_data.gstda.get_layer_top("lith", "V", min_depth=2)
        expected_boreholes_returned = ["B", "D"]
        ...
        result = borehole_data.gstda.get_layer_top(
        ...
        result = borehole_data.gstda.get_layer_top("lith", ["Z", "K"])
        expected_boreholes_returned = ["A", "B", "C", "D", "E"]
    ...
    def test_slice_depth_interval(self, borehole_data):
        ...
        sliced = borehole_data.gstda.slice_depth_interval(
        ...
        empty_slice = borehole_data.gstda.slice_depth_interval(-2, -1)
        empty_slice_nap = borehole_data.gstda.slice_depth_interval(
        ...
        upper = 4
        sliced = borehole_data.gstda.slice_depth_interval(upper)
    ...
    def test_select_by_condition(self, borehole_data):
        ...
        selected = borehole_data.gstda.select_by_condition(
    ...
    def test_to_pyvista_cylinders(self, borehole_data):
        ...
        multiblock = borehole_data.gstda.to_pyvista_cylinders("lith")
        ...
        multiblock = borehole_data.gstda.to_pyvista_cylinders(
            "lith", vertical_factor=10
        )
    ...
    def test_to_pyvista_grid(self, borehole_data):
        grid = borehole_data.gstda.to_pyvista_grid(["lith"], radius=0.1)
    ...
    def test_to_datafusiontools(self, borehole_data):
        # Test normal export.
        dft = borehole_data.gstda.to_datafusiontools("lith")
        ...
        dft = borehole_data.gstda.to_datafusiontools(
            "lith", relative_to_vertical_reference=False
        )
    ...
    def test_to_datafusiontools_with_file(self, borehole_data):
        ...
        borehole_data.gstda.to_datafusiontools("lith", outfile)
    ...
    def test_to_qgis3d(self, borehole_data):
        ...
        borehole_data.gstda.to_qgis3d(outfile, crs=28992)
        assert outfile.is_file()
        outfile.unlink()
    ...
    def test_to_kingdom(self, borehole_data):
        ...
        borehole_data.gstda.to_kingdom(outfile)
        assert outfile.is_file()
    ...
    def test_change_depth_values(self, borehole_data):
        ...
        borehole = borehole_data.gstda._change_depth_values(borehole)
    ...
    def test_to_iterable(self, borehole_data):
        inst = "string"
        inst = borehole_data.gstda._to_iterable(inst)
